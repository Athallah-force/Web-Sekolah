...
if (isset($_POST['simpan'])) {
    ...
    try {
        $result = $db->tambah_data($nisn, $nama, $jeniskelamin, $kodejurusan, $kelas, $alamat, $agama, $nohp);
                    ...
                    <div class="card-body">
                        <form action="" method="post">
                            ...
                            <div class="mb-3">
                                ...
                                <select name="kodejurusan" id="kodejurusan" class="form-select" required>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" 
                                       ...
                                       pattern="[0-9]{1,14}"
                                       title="Nomor HP maksimal 14 digit">
                            </div>
                            <div class="mb-3">
