        ...
        <div class="container-fluid">
          ...
          <div class="card mb-12">
            ...
            <div class="card-body p-0">
                ...
                <tbody>
                  ...
                  <td>
                      ...
                      <button 
                        ...
                        data-id="<?= $x['id']; ?>"
                        data-username="<?= htmlspecialchars($x['username']); ?>"
                        data-password="<?= htmlspecialchars($x['password']); ?>"
                        data-role="<?= $x['role']; ?>"
                      >
              ...
              <a href="tambahusers.php" class ="btn btn-primary float-end"><i class="bi bi-plus-circle"></i>Tambah Data Users</a>
            </div>
            <!-- /.card-body -->
          </div>
          <!-- /.card -->
        ...
        <div class="modal-content" style="background: none; box-shadow: none; border: none; padding: 0;">
          <form action="updateusers.php" method="POST" id="formEdit">
            <div class="modal-header bg-warning" style="border:none; box-shadow:none;">
              <h5 class="modal-title" id="labelEdit">Edit User</h5>
...
<div class="modal fade" id="modalHapus" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="labelHapus" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <form action="hapususers.php" method="GET" id="formHapus">
        ...
        <div class="modal-body">
          ...
          <p><strong>ID:</strong> <span id="hapusId"></span></p>
          <p><strong>Username:</strong> <span id="hapusUsername"></span></p>
        </div>
        <input type="hidden" name="iduser" id="hapusIdInput" value="">
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    document.querySelectorAll('.btn-edit').forEach(button => {
      button.addEventListener('click', () => {
        ...
        for (const option of editRole.options) {
    ...
    const hapusIdInput = document.getElementById('hapusIdInput');

    document.querySelectorAll('.btn-delete').forEach(button => {
      button.addEventListener('click', () => {
        hapusId.textContent = button.getAttribute('data-id');
        hapusUsername.textContent = button.getAttribute('data-username');
        hapusIdInput.value = button.getAttribute('data-id');
      });
    });
  });
</script>
...
<style>
  /* Remove white background outside the form in modal */
