...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($username && $password && $role) {
        ...
        if (!in_array($role, $allowed_roles)) {
            ...
            // Hash the password before storing (optional but recommended)
  ...
  <small>Member since <?php echo date("M. Y"); ?></small>
    ...
    <main class="app-main">
        <div class="app-content-header">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-sm-6"><h3 class="mb-0">Tambah Data Users</h3></div>
                    <div class="col-sm-6">
        ...
        <div class="app-content">
            <div class="container-fluid">
                <div class="card">
                    <div class="card-header"><h3 class="card-title">Form Tambah Users</h3></div>
                    <div class="card-body">
                        <?php if (isset($error)) : ?>
