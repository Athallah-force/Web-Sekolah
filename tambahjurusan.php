...
if (isset($_POST['simpan'])) {
    ...
    try {
        $result = $db->tambah_jurusan($namajurusan);
  ...
  <small>Member since <?php echo date("M. Y"); ?></small>
    ...
    <main class="app-main">
        ...
        <div class="app-content">
            <div class="container-fluid">
                <div class="card">
                    <div class="card-header"><h3 class="card-title">Form Tambah Jurusan</h3></div>
                    <div class="card-body">
                        <?php if (isset($error)) : ?>
                        ...
                        <form action="" method="post">
                            <div class="mb-3">
                                ...
                                <input type="text" name="namajurusan" id="namajurusan" class="form-control" required />
                            </div>
