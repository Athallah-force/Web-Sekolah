...
// Get total number of agama for pagination
$total_agama_result = mysqli_query($db->koneksi, "SELECT COUNT(*) as total FROM agama");
$total_agama_row = mysqli_fetch_assoc($total_agama_result);
$total_agama = $total_agama_row['total'];
$total_pages = ceil($total_agama / $items_per_page);

if ($_POST && isset($_POST['idagama'])) {
    $idagama = $_POST['idagama'];
    $namaagama = $_POST['namaagama'];

    $db->update_data_agama($idagama, $namaagama);
  ...
  <div class="container-fluid">
    ...
    <div class="card mb-4">
      <div class="card-header">
        <h3 class="card-title">Tabel Agama</h3>
      </div>
      <!-- /.card-header -->
      <div class="card-body p-0">
        <table class="table table-striped">
          ...
          <tbody>
            <?php
            $no = $offset + 1;
            foreach ($db->tampil_agama($items_per_page, $offset) as $x) {
            ?>
              <tr>
                  <td><?= $no++; ?></td>
                  ...
                  <button 
                      ...
                      data-namaagama="<?= htmlspecialchars($x['namaagama']); ?>"
                    >
        ...
        <?php if ($_SESSION['role'] === 'admin'): ?>
        <a href="tambahagama.php" class ="btn btn-primary float-end"><i class="bi bi-plus-circle"></i>Tambah Data Agama</a>
        <?php endif; ?>
      </div>
    </div>
  </div>
      ...
      <div class="modal-content">
        <form action="" method="POST" id="formEdit">
          <div class="modal-header bg-warning">
            <h5 class="modal-title" id="labelEdit">Edit Data Agama</h5>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
          </div>
          <div class="modal-body">
            <input type="hidden" name="idagama" id="editIdagama" value="">
            <div class="mb-3">
              <label for="editNamaagama" class="form-label">Nama Agama</label>
              <input type="text" class="form-control" id="editNamaagama" name="namaagama" required>
            </div>
          </div>
      ...
      <div class="modal-content">
        <form action="hapus.php" method="GET" id="formHapus">
          ...
          <div class="modal-body">
            ...
            <p><strong>ID Agama:</strong> <span id="hapusIdagama"></span></p>
            <p><strong>Nama Agama:</strong> <span id="hapusNamaagama"></span></p>
          </div>
          <input type="hidden" name="idagama" id="hapusIdagamaInput" value="">
          <div class="modal-footer">
            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
